...
class CategoryScreenViewModel extends BaseViewModel {
  ...
  void init(String categoryName,BuildContext context) {
...
// showBottomSheet
  showDetailSheet(context, Map<String, dynamic> data, CategoryScreenViewModel viewModel) {
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        style: TextStyle(
                          ...
                          fontWeight: FontWeight.w600,
                          fontSize: 11.5, fontFamily: 'Montserrat',
                          height: 1.5
                        ),
                        textAlign: TextAlign.start,
                      ),
                      const Gap(8),
                      const Divider(color: Colors.grey,endIndent: 10,),
                      const Gap(8),
                      const Text(
                        "Select Brand",
                        style: TextStyle(
